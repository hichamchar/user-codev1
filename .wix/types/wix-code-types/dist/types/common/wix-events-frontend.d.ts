...
declare module 'wix-events-frontend' {
    ...
    namespace Tickets {
        ...
        /**
         * An object containing information about a checkout performed using the [`checkout()`](https://dev.wix.com/docs/velo/api-reference/wix-events-frontend/tickets/reserve) function.
         */
        ...
        /**
         * An object containing information about a reservation created using the [`reserve()`](https://dev.wix.com/docs/velo/api-reference/wix-events-frontend/tickets/reserve) function.
         */
