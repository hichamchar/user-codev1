...
declare module 'wix-pricing-plans-frontend' {
    ...
    /**
     * The Custom Purchase Flow API contains functionality for customizing the plan purchase flow on your site.
    ...
    namespace CustomPurchaseFlow {
        ...
        /**
         * Options to customize the Thank You page that is displayed after a customer purchases a plan.
         */
        type ThankYouPage = {
            /**
             ...
             * It must be a page on your site.
             */
        ...
        type navigation = {
            /**
             * URL of a page on your site. The link may be relative or your site's base URL. Examples:
             * + `/home`
    ...
    namespace Orders {
         ...
         *
         * To learn more about coupons, see [applyCoupon()](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/apply-coupon).
         */
        type Coupon = {
            /**
        ...
        type CurrentMemberFilterOptions = {
             ...
             *  + `"PAUSED"`. Use of the plan has been [paused](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/pause-order), for example, if the buyer is away. The plan can be [resumed](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/resume-order).
             *  + `"ENDED"`. The order has completed its duration and is no longer available for use.
             *  + `"CANCELED"`. The order has been [canceled](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/cancel-order).
             */
        ...
        type Order = {
             ...
             *
             * Created by the [`createOnlineOrder()`](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/create-online-order) or [`createOfflineOrder()`](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/create-offline-order) function. For online orders, send this value as a parameter to the Wix Pay [`startPayment()`](wix-pay-frontend/startPayment) function to enable your buyer to pay for the order. `wixPayOrderId` is omitted if the order is free.
             */
            ...
            /**
             * Order [pricing model](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/introduction#pricing-models), price, and payment schedule.
             */
             ...
             *  + `"PAUSED"`. The order, and use of the plan, is [paused](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/pause-order). For example, if the buyer is away. The order, and use of the plan, can be [resumed](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/resume-order).
             *  + `"ENDED"`. The order has completed its duration and is no longer available for use.
             *  + `"CANCELED"`. The order has been [canceled](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/cancel-order).
             */
            status: string;
             ...
             *
             * `endDate` may be updated over the course of an order. If the order is [paused](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/pause-order), it will have a later `endDate` once it [resumes](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/resume-order). `endDate` may also be [postponed](https://dev.wix.com/docs/velo/apis/wix-pricing-plans-v2/orders/postpone-end-date).
             *
